#!/bin/bash
#SBATCH --job-name=openvla_spatial_s2
#SBATCH --partition=gpu-3day
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=16
#SBATCH --mem=32GB
#SBATCH --time=12:00:00
#SBATCH --output=/nfs_home/users/%u/openvla/logs/slurm_spatial_s2_%j.out
#SBATCH --error=/nfs_home/users/%u/openvla/logs/slurm_spatial_s2_%j.err
