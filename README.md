...
**CAISc 2026 Submission | Team HandofGod | BITS Pilani**
...
|------|-----------|---------|
| C1 | Baseline (seen visual + seen language) | 0.36 |
| C2 | Linguistic stress (novel paraphrase) | 0.227 |
| C3 | Visual stress (pose perturbation) | TBD |
| C4 | Full novel (both) | TBD |

**CGG_ling** = 0.36 − 0.227 = **+0.133**

*C3 and C4 results pending; will be updated upon experiment completion.*
